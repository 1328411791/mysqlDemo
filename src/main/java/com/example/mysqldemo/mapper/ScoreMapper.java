...
public interface ScoreMapper extends BaseMapper<Score> {
    ...
    // 从Student表中查询学生的所有成绩
    @Select("SELECT student.school_id,student.student_name,course_name,score,score.course_id,teacher_name,course_id,score.id id FROM student,course,score,teacher WHERE student_id=student.id AND course.id=score.course_id AND course.teacher_id=teacher.id; WHERE student.student_name like CONCAT('%',#{studentName},'%');")
